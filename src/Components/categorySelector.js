...
const CategorySelector = (props) => {
  ...
  return (
    <>
      <div>
        <div>
          <ToggleButton checked={points} onChange={(e) => setPoints(e.value)} onLabel="Pts" offLabel="Pts" onIcon="pi pi-check" offIcon="pi pi-times" style={{ width: '75px' }} />
          <ToggleButton checked={assists} onChange={(e) => setAssists(e.value)} onLabel="Ast" offLabel="Ast" onIcon="pi pi-check" offIcon="pi pi-times" style={{ width: '75px' }} />
